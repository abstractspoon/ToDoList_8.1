...
const LPCTSTR DOWNLOAD_URI				= _T("https://github.com/abstractspoon/ToDoList_Prev/blob/master/todolist_exe.zip");
const LPCTSTR DOWNLOAD_URI_PRERELEASE	= _T("https://github.com/abstractspoon/ToDoList_Prev/blob/master/todolist_exe_pre.zip");
